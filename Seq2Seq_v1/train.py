...
from model import Seq2Seq_v1, Encoder, Decoder, init_weights
...
def train_epoch(mode, dataset_id, criterion, train_dataloader, model, epoch, tb_logger, print_every=50, clip=1):
...
if __name__ == '__main__':
    ...
    dataset_id = 'kyoto_lexicon'  # kyoto_lexicon anki merged
    ...
    enc = Encoder(src_vocab, ENC_EMB_DIM, HID_DIM, N_LAYERS, ENC_DROPOUT)
    dec = Decoder(trg_vocab, DEC_EMB_DIM, HID_DIM, N_LAYERS, DEC_DROPOUT)
    model = Seq2Seq_v1(enc, dec, device).to(device)
