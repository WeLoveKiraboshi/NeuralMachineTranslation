...
if __name__ == '__main__':
    ...
    # print('僕は駅に行く途中なの', translate_sentence('僕は駅に行く途中なの', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
    # print('駅に行く途中なの。', translate_sentence('駅に行く途中なの', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
    # print('私は彼が医者であるかどうかわからない。', translate_sentence('私は彼が医者であるかどうかわからない。', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
    # print('お話し中、申し訳ありません。', translate_sentence('お話し中、申し訳ありません。', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
    # print('東京オリンピック組織委員会。', translate_sentence('東京オリンピック組織委員会。', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
    # print('日本語は難しいと思います', translate_sentence('日本語は難しいと思います', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
    # print('英語は簡単です', translate_sentence('英語は簡単です', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
    # print('京都は東京の街です。', translate_sentence('京都は東京の街です。', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
    # print('京都', translate_sentence('京都', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
    # print('寺', translate_sentence('寺', JA_TEXT, EN_TEXT, model, device, max_len=50)[0])
